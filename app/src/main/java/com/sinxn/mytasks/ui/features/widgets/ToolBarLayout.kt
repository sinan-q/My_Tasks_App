package com.sinxn.mytasks.ui.features.widgets
...
import com.sinxn.mytasks.ui.features.widgets.ToolBarLayoutSize.Companion.canShowHeaderTitle
import com.sinxn.mytasks.ui.features.widgets.ToolBarLayoutSize.Companion.canUseFilledButtons
import com.sinxn.mytasks.ui.features.widgets.ToolBarLayoutSize.Companion.numberOfContentButtonsInTwoRowGrid
import com.sinxn.mytasks.ui.features.widgets.ToolBarLayoutSize.Companion.numberOfItemsThatFit
...
fun ToolBarLayout(
  ...
  when (val layoutSize = ToolBarLayoutSize.fromLocalSize()) {
    ToolBarLayoutSize.HorizontalRow, ToolBarLayoutSize.VerticalColumn -> {
 ...
 * @see [ToolBarLayoutSize.HeaderTwoRowGrid]
 */
@Composable
private fun Header(
  appIconRes: Int,
 ...
 * @see [ToolBarLayoutSize.HorizontalRow], [ToolBarLayoutSize.VerticalColumn] & [ToolBarLayoutSize.TwoRowGrid]
 */
@Composable
