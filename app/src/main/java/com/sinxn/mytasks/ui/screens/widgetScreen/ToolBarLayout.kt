...
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutDimens.iconSize
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutDimens.itemsSpacing
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutDimens.minButtonSize
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutDimens.widgetPadding
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutSize.Companion.canShowHeaderTitle
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutSize.Companion.canUseFilledButtons
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutSize.Companion.numberOfContentButtonsInTwoRowGrid
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutSize.Companion.numberOfItemsThatFit
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutSize.HeaderTwoRowGrid
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutSize.HorizontalRow
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutSize.TwoRowGrid
import com.sinxn.mytasks.ui.screens.widgetScreen.ToolBarLayoutSize.VerticalColumn
  ...
  when (val layoutSize = ToolBarLayoutSize.fromLocalSize()) {
    HorizontalRow, VerticalColumn -> {
      ...
      Scaffold(
        ...
        val allItems = listOf(appIconItem) + buttonItems
    ...
    TwoRowGrid -> {
      ...
      Scaffold(
        ...
        TwoRowGrid(
          items = listOf(appIconItem) + contentButtonsToShow,
          spacing = itemsSpacing,
          modifier = GlanceModifier.fillMaxSize(),
        )
      }
...
private enum class ToolBarLayoutSize {
  ...
  companion object {
    ...
    /**
     * Returns how man  y items to show that would potentially fit in the given orientation
